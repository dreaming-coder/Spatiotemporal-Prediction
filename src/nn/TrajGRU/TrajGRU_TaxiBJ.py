...
__all__ = ["TrajGRU_TaxiBJ"]


class TrajGRU_TaxiBJ(EnhancedModule):
    ...
    def forward(self, x: Tensor, out_len: int = 4) -> Tensor:
        r"""
        :param x:
        :param out_len:
        :return:
...
class Forecast(nn.Module):
    ...
    def forward(self, h_states: Tensor, out_len: int = 4) -> Tensor:
        r"""
        :param h_states:
        :param out_len:
        :return:
